...
def evaluate(request):
    ...
    try:
        ...
        Riasec_result.objects.update(user=name,realistic=r, investigative=i, artistic=a, social=s,enterprising=e, conventional=c)

    except ObjectDoesNotExist:
        result=Riasec_result.objects.create(user=name,realistic=r, investigative=i, artistic=a, social=s,enterprising=e, conventional=c)
        result.save()
...
class Home(LoginRequiredMixin,ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        obj = Riasec_result.objects.values('realistic', 'investigative', 'artistic', 'social', 'enterprising', 'conventional').first()
        if obj is not None:
